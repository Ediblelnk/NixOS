...
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1, bezier = "circ", style = "gnomed" })
--
hl.animation({ leaf = "fadeIn", enabled = false })
hl.animation({ leaf = "fadeOut", enabled = true, speed = 10, bezier = "cubic" })
hl.animation({ leaf = "fade", enabled = true, speed = 1, bezier = "cubic" })
--
hl.animation({ leaf = "layersIn", enabled = true, speed = 1, bezier = "cubic", style = "slide" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 1, bezier = "cubic", style = "slide" })
--
hl.animation({ leaf = "fadeLayersIn", enabled = false })
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 10, bezier = "cubic" })
--
